...
/***********************************************************************
 函数名      ：TIM8_PWM1(u16 arr,u16 psc)  
 函数功能    ：TIM8通道 1 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM8_PWM1(u16 arr,u16 psc)
{ 
...
/***********************************************************************
 函数名      ：TIM8_PWM2(u16 arr,u16 psc)  
 函数功能    ：TIM8通道 2 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM8_PWM2(u16 arr,u16 psc)
{ 
    TIM_Handler.Instance=TIM8;                               //定时器8
    TIM_Handler.Init.Prescaler=psc;                          //定时器分频
    TIM_Handler.Init.CounterMode=TIM_COUNTERMODE_UP;         //向上计数模式
...
/***********************************************************************
 函数名      ：TIM8_PWM3(u16 arr,u16 psc)  
 函数功能    ：TIM8通道 3 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM8_PWM3(u16 arr,u16 psc)
{ 
    TIM_Handler.Instance=TIM8;                              //定时器8
    TIM_Handler.Init.Prescaler=psc;                         //定时器分频
    TIM_Handler.Init.CounterMode=TIM_COUNTERMODE_UP;        //向上计数模式
...
/***********************************************************************
 函数名      ：TIM8_PWM4(u16 arr,u16 psc)  
 函数功能    ：TIM8通道 4 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM8_PWM4(u16 arr,u16 psc)
{ 
    TIM_Handler.Instance=TIM8;                               //定时器8
    TIM_Handler.Init.Prescaler=psc;                          //定时器分频
    TIM_Handler.Init.CounterMode=TIM_COUNTERMODE_UP;         //向上计数模式
...
/***********************************************************************
 函数名      ：TIM5_PWM4(u16 arr,u16 psc)  
 函数功能    ：TIM5通道 4 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM5_PWM4(u16 arr,u16 psc)
{ 
...
/***********************************************************************
 函数名      ：TIM3_PWM2(u16 arr,u16 psc)  
 函数功能    ：TIM3通道 2 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM3_PWM2(u16 arr,u16 psc)
{ 
...
/***********************************************************************
 函数名      ：TIM1_PWM4(u16 arr,u16 psc)  
 函数功能    ：TIM1通道 4 PWM输出函数
 输入        ：arr：自动重装值；psc：时钟预分频数
 输出        ：无
                           
************************************************************************/
void TIM1_PWM4(u16 arr,u16 psc)
{ 
