...
//复位补偿
u16 M3GDL_BC=1000;		//3号电机左翻复位补偿
u16 M3GDR_BC=550;		//3号电机右翻复位补偿
u16 M4GDL_BC=1000;		//4号电机右翻复位补偿
u16 M4GDR_BC=400;		//4号电机右翻复位补偿
u16 M5GDL_BC=0;			//5号电机右翻复位补偿
u16 M5GDR_BC=0;			//5号电机右翻复位补偿
